...
const QUOTES: Quote[] = [
  {
    ...
    node: (
      <>
        ...
        say, what may be the most complex object in existence; one wet kilogram
  ...
  },
  {
    ...
    node: (
      <>
        ...
        universe... Borrowed time and borrowed world and borrowed eyes with
        which to sorrow it. ”
      </>
    ),
    author: "CORMAC MCCARTHY, THE ROAD",
  ...
  },
  {
    ...
    node: <>“Query: How does the never to be differ from what never was?”</>,
    author: "CORMAC MCCARTHY, THE ROAD",
  },
  {
